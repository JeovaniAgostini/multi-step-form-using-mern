...
router.post('/login', async (req, res) => {
    try {
        ...
        /*
            If the password matches, then we create a new rest 
            object with all the user properties except the hashed 
            password using the ES9 rest operator for objects.
        */
